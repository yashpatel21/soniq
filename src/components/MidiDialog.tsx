																			...
																			<TooltipProvider>
																				<Tooltip>
																					...
																					<TooltipContent side="top" className="max-w-[180px]">
																						Controls how sensitive the algorithm is to detecting
																						new notes. Higher values require stronger onsets.
																					</TooltipContent>
																				</Tooltip>
																			</TooltipProvider>
																		</div>
																		...
																		<div className="flex items-center gap-1">
																			...
																			<TooltipProvider>
																				<Tooltip>
																					...
																					<TooltipContent side="top" className="max-w-[180px]">
																						Determines how loud a note needs to be to be
																						detected. Higher values require louder notes.
																					</TooltipContent>
																				</Tooltip>
																			</TooltipProvider>
																		</div>
